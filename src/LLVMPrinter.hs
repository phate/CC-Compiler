...
printDType (DType TInt i) = "{i32, [ 0 x " ++ (printDType (DType TInt (i-1))) ++ "] }*"
printDType (DType TDouble i) = "i32, {[ 0 x " ++ (printDType (DType TDouble (i-1))) ++ "] }*"
printDType (DType TBool i) = "{i32, [ 0 x " ++ (printDType (DType TBool (i-1))) ++ "] }*"
